...
import Burndown from "@/views/display/pages/burndown/root.vue";
...
describe("views/display/pages/burndown", () => {
  it("renders views/display/pages/burndown/root.vue", async () => {
    const msg =
      "Burndown";
    ...
    const wrapper = shallowMount(Burndown, {
